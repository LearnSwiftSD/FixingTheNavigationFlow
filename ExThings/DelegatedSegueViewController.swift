//
//  DelegatedSegueViewController.swift
//
//  Base class for a UIViewController with all navigation concerns delegated.
//
...
class DelegatedSegueViewController: UIViewController {
